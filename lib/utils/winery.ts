...
export const standardizeWineryData = (
  ...
  const favoriteIsPrivate = source.is_favorite_private !== undefined ? source.is_favorite_private : (source.favorite_is_private !== undefined ? source.favorite_is_private : (existing?.favoriteIsPrivate ?? false));
