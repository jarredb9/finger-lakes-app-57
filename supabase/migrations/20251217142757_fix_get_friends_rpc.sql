-- Update RPC to fetch accepted friends, incoming requests, AND sent requests.
-- This ensures the function is up-to-date even if previous migrations were missed.
