-- Add user_rating_count column to wineries table if it doesn't exist
ALTER TABLE public.wineries ADD COLUMN IF NOT EXISTS user_rating_count integer;

-- Update bulk_upsert_wineries to include user_rating_count and ensure all columns are handled
...
-- Update get_winery_details_by_id to include user_rating_count
