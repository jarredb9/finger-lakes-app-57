-- Fix handle_activity_ledger_entry trigger to avoid accessing non-existent fields on NEW/OLD records.
-- Postgres validates field access at runtime for all branches of a CASE statement.
-- Restoring explicit IF/ELSE blocks per table to ensure safety across schema differences.
