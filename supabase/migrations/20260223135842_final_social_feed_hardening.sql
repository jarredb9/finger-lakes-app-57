-- Final hardening for get_friend_activity_feed
-- Ensures robust user identification and efficient filtering.
...
BEGIN
    ...
    WHERE (v.user_id = ANY(COALESCE(v_friend_ids, ARRAY[]::uuid[])) OR v.user_id = v_caller_id)
