-- Migration: 20260403000001_fix_friend_profile_privacy_for_owner.sql
-- Fix get_friend_profile_with_visits to allow owner to see their own private items in counts
