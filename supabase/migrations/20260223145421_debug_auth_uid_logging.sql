-- Add RAISE NOTICE logging for auth.uid() in social RPCs
-- This helps verify user identification in E2E environments.
...
DECLARE
    ...
    result jsonb;
BEGIN
    RAISE NOTICE 'get_friends_and_requests called by auth.uid(): %', v_user_id;
...
BEGIN
    ...
    RAISE NOTICE 'get_friend_activity_feed called by auth.uid(): %', v_caller_id;
