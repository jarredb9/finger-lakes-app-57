...
ALTER FUNCTION public.get_wineries_in_bounds(numeric, numeric, numeric, numeric) SET search_path = public, auth;
...
ALTER FUNCTION public.search_wineries_by_name_and_location(text, numeric, numeric, integer) SET search_path = public, auth;
...
REVOKE EXECUTE ON FUNCTION public.get_wineries_in_bounds(numeric, numeric, numeric, numeric) FROM PUBLIC, anon, authenticated;
...
REVOKE EXECUTE ON FUNCTION public.search_wineries_by_name_and_location(text, numeric, numeric, integer) FROM PUBLIC, anon, authenticated;
...
GRANT EXECUTE ON FUNCTION public.get_wineries_in_bounds(numeric, numeric, numeric, numeric) TO authenticated;
...
GRANT EXECUTE ON FUNCTION public.search_wineries_by_name_and_location(text, numeric, numeric, integer) TO authenticated;
