...
ALTER FUNCTION public.create_trip_with_winery(character varying, date, jsonb, text, uuid[]) SET search_path = public, auth;
...
ALTER FUNCTION public.get_all_user_visits_list() SET search_path = public, auth;
ALTER FUNCTION public.get_all_wineries_with_user_data() SET search_path = public, auth;
ALTER FUNCTION public.get_friend_activity_feed(integer) SET search_path = public, auth;
ALTER FUNCTION public.get_friend_profile_with_visits(uuid) SET search_path = public, auth;
ALTER FUNCTION public.get_friends_activity_for_winery(integer) SET search_path = public, auth;
...
ALTER FUNCTION public.get_paginated_trips_with_wineries(text, integer, integer) SET search_path = public, auth;
ALTER FUNCTION public.get_paginated_wineries(integer, integer) SET search_path = public, auth;
ALTER FUNCTION public.get_trip_by_id_with_wineries(integer) SET search_path = public, auth;
...
ALTER FUNCTION public.get_wineries_for_trip_planner(date) SET search_path = public, auth;
ALTER FUNCTION public.get_wineries_in_bounds(double precision, double precision, double precision, double precision, double precision, double precision, double precision, double precision) SET search_path = public, auth;
ALTER FUNCTION public.get_winery_details(integer) SET search_path = public, auth;
ALTER FUNCTION public.get_winery_details_by_id(integer) SET search_path = public, auth;
ALTER FUNCTION public.search_wineries_by_name_and_location(text, double precision, double precision, double precision, double precision) SET search_path = public, auth;
...
REVOKE EXECUTE ON FUNCTION public.create_trip_with_winery(character varying, date, jsonb, text, uuid[]) FROM PUBLIC, anon, authenticated;
...
REVOKE EXECUTE ON FUNCTION public.get_all_user_visits_list() FROM PUBLIC, anon, authenticated;
REVOKE EXECUTE ON FUNCTION public.get_all_wineries_with_user_data() FROM PUBLIC, anon, authenticated;
REVOKE EXECUTE ON FUNCTION public.get_friend_activity_feed(integer) FROM PUBLIC, anon, authenticated;
REVOKE EXECUTE ON FUNCTION public.get_friend_profile_with_visits(uuid) FROM PUBLIC, anon, authenticated;
REVOKE EXECUTE ON FUNCTION public.get_friends_activity_for_winery(integer) FROM PUBLIC, anon, authenticated;
...
REVOKE EXECUTE ON FUNCTION public.get_paginated_trips_with_wineries(text, integer, integer) FROM PUBLIC, anon, authenticated;
REVOKE EXECUTE ON FUNCTION public.get_paginated_wineries(integer, integer) FROM PUBLIC, anon, authenticated;
REVOKE EXECUTE ON FUNCTION public.get_trip_by_id_with_wineries(integer) FROM PUBLIC, anon, authenticated;
...
REVOKE EXECUTE ON FUNCTION public.get_wineries_for_trip_planner(date) FROM PUBLIC, anon, authenticated;
REVOKE EXECUTE ON FUNCTION public.get_wineries_in_bounds(double precision, double precision, double precision, double precision, double precision, double precision, double precision, double precision) FROM PUBLIC, anon, authenticated;
REVOKE EXECUTE ON FUNCTION public.get_winery_details(integer) FROM PUBLIC, anon, authenticated;
REVOKE EXECUTE ON FUNCTION public.get_winery_details_by_id(integer) FROM PUBLIC, anon, authenticated;
REVOKE EXECUTE ON FUNCTION public.search_wineries_by_name_and_location(text, double precision, double precision, double precision, double precision) FROM PUBLIC, anon, authenticated;
