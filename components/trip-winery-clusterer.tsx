        ...
        renderer: {
          render: ({ count, position, markers }) => {
            ...
            const svg = `<svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 40 40">
                <path fill="#0284c7" stroke="#0369a1" stroke-width="2" d="M20 38.5C20 38.5 5 24.75 5 17.5A15 15 0 0 1 20 2.5a15 15 0 0 1 15 15c0 7.25-15 22-15 22Z"/>
  ...
  useEffect(() => {
    ...
    const newMarkers = wineries.map((winery, index) => {
      ...
      const svg = `<svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 36 36">
        <path fill="#0284c7" stroke="#0369a1" stroke-width="1.5" d="M18 34.5C18 34.5 4 21.375 4 15A14 14 0 0 1 18 1a14 14 0 0 1 14 14c0 6.375-14 19.5-14 19.5Z"/>
