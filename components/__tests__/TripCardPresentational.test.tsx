...
describe('TripCard', () => {
  ...
  it('renders correctly including reviews and distance', async () => {
    const tripWithTwo = {
      ...mockTrip,
      wineries: [
        ...mockTrip.wineries!,
    ...
    await screen.findByTestId('winery-list');
  ...
  it('performs reordering via handleDrop', async () => {
    const tripWithTwo = {
      ...
      wineries: [
        ...mockTrip.wineries!,
        { id: 'winery-2' as any, dbId: 102 as any, name: 'Winery Two' }
      ]
    };
    render(<TripCard {...defaultProps} trip={tripWithTwo as any} />);
    await screen.findByTestId('winery-list');
  ...
  it('renders search results from props', async () => {
    const mockSearchResults = [{ id: 'winery-2' as any, dbId: 102 as any, name: 'Search Result', address: '456 Wine Ave' }];
