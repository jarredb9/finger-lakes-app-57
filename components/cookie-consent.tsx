...
export function CookieConsent() {
  ...
  return (
    <aside 
        className="fixed bottom-0 left-0 right-0 z-[60] lg:bottom-4 lg:left-auto lg:right-4 lg:w-[340px] lg:max-w-sm pointer-events-none"
        aria-label="Cookie consent"
    >
      <div className="lg:hidden bg-background border-t p-4 flex items-center justify-between gap-4 shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.1)] pointer-events-auto">
      ...
      <Card className="hidden lg:block shadow-lg border-primary/20 pointer-events-auto">
