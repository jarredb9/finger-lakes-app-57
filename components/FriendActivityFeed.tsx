...
export default function FriendActivityFeed() {
  ...
  const isEmpty = !friendActivityFeed || friendActivityFeed.length === 0;

  return (
    <div className="space-y-4" data-testid="friend-activity-feed" data-state={isLoading && isEmpty ? 'loading' : 'ready'}>
