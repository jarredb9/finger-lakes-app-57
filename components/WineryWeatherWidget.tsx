...
export function WineryWeatherWidget({ latitude, longitude, className = '' }: WineryWeatherWidgetProps) {
  ...
  return (
    <div data-testid="winery-weather-widget" className={`flex items-center gap-1.5 text-xs font-medium text-foreground/80 bg-muted/30 border border-border/40 rounded-full px-3 py-1 w-fit backdrop-blur-sm ${className}`}>
