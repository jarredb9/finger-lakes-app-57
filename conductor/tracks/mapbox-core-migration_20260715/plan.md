...
- [ ] Task: Install `react-map-gl` and `mapbox-gl`.
...
## Phase 2: React Context & Hook Refactoring
...
- [ ] Task: Implement the floating Google attribution badge in the bottom-left corner of the map.
